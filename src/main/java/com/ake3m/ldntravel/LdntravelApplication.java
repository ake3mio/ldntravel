...
import com.ake3m.ldntravel.oyster.service.OysterCardPaymentService;
...
public class LdntravelApplication {

    public static void main(String[] args) {
        SpringApplication.run(LdntravelApplication.class, args);
    }

    @Configuration
    @RequiredArgsConstructor
    private static class CommandLineApplication implements CommandLineRunner {

        private final OysterCardPaymentService cardPaymentService;
        ...
        public void run(String... args) {
            ...
            while (true) {
                ...
                var commandType = isValidOption ? CommandType.valueOf(commandOption.toUpperCase()) : CommandType.HELP;
        ...
        private void startJourney() {
            ...
            transportMethodType = TransportMethodType.valueOf(option.toUpperCase());
